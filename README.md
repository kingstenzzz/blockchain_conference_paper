...
[Consensus-PoW] [Fast Difficulty Adjustment in Proof-of-Work Consensus](https://eprint.iacr.org/2026/1116). Juan Garay, Aggelos Kiayias, Yu Shen. Crypto '26.

[Consensus] [Permissionless Consensus from a Common Random String](https://eprint.iacr.org/2026/1179). Damiano Abram, Marshall Ball, Juan Garay, Aggelos Kiayias. Crypto '26.

[Consensus] [Faster Leader-Based Consensus via Certificates of Exclusivity and Overlapping Iterations](https://eprint.iacr.org/2026/1214). Matthieu Rambaud. Crypto '26.

[Consensus] [Gatling: Rapid-Fire Consensus from Parallel Composition](https://eprint.iacr.org/2026/1269). Giulia Scaffino, Max Resnick, Joachim Neu. Crypto '26.

[Consensus-Sleepy] [On the Communication Complexity of Sleepy Consensus](https://eprint.iacr.org/2026/960). Qiang Tang, Yuchen Ye. Crypto '26.

[Consensus] [BumbleBee: Best-of-Both-Worlds MVBA with Optimal Communication, Latency and Resilience Tradeoffs](https://eprint.iacr.org/2026/989). Fatima Elsheimy, Simon Holmgaard Kamp. Crypto '26.
...
[Consensus] [Mechanized Safety and Liveness Proofs for the Mysticeti Consensus Protocol under the LiDO-DAG Framework](). Longfei Qiu, Jingqi Xiao, Zhong Shao. IEEE S&P '26.

[Consensus] [Scalable Accountable Byzantine Agreement and Beyond](). Pierre Civit, Daniel Collins, Vincent Gramoli, Rachid Guerraoui, Jovan Komatovic, Manuel Vidigueira, Pouriya Zarbafian. IEEE S&P '26.

[Consensus] [Fast Deterministically Safe Proof-of-Work Consensus](). Ali Farahbakhsh, Giuliano Losa, Youer Pu, Lorenzo Alvisi. IEEE S&P '26.
...
[Crypto-ZK] [zkFuzz: Foundation and Framework for Effective Fuzzing of Zero-Knowledge Circuits](). Hideaki Takahashi, Jihwan Kim, Suman Jana, Junfeng Yang. IEEE S&P '26.
...
[Crypto] [BulletCT: Towards More Scalable Ring Confidential Transactions With Transparent Setup](). Nan Wang, Qianhui Wang, Dongxi Liu, Muhammed F. Esgin, Alsharif Abuadbba. USENIX Security '25.
...
[ZK-Rollup] [Towards a Formal Foundation for Blockchain ZK Rollups](). Stefanos Chaliasos, Denis Firsov, Benjamin Livshits. CCS '25.

[Consensus-Fairness] [Ambush Attack on Batch-Order Fair Byzantine Consensus](). Eunchan Park, Taeung Yoon, Hocheol Nam, Deepak Maram, Min Suk Kang. CCS '25.

[Consensus] [Aegis: Tethering a Blockchain with Primary-Chain Stake](). Yogev Bar-On, Roi Bar-Zur, Omer Ben-Porat, Nimrod Cohen, Ittay Eyal, Matan Sitbon. CCS '25.

[Security] [Denial of Sequencing Attacks in Ethereum Layer 2 Rollups](). Zihao Li, Zhiyuan Sun, Zheyuan He, Jinzhao Chu, Hao Zhou, Xiapu Luo, Ting Chen, Yinqian Zhang. CCS '25.

[Sharding] [Camael: Realizing Corrupted-Shard Tolerance in Sharding Blockchain](). Yizhong Liu, Andi Liu, Yuan Lu, Zhuocheng Pan, Yinuo Li, Jianwei Liu, Song Bian, Mauro Conti. CCS '25.

[Consensus] [Larger Scale Offers Better Security in the Nakamoto-style Blockchain](https://arxiv.org/abs/2509.05708). Junjie Hu. CCS '26.

[Consensus] [Synchronous BFT with Provability and Fast Path for the Age of Blockchains](https://eprint.iacr.org/2026/639). Ittai Abraham, Kartik Nayak, Ling Ren, Ertem Nusret Tas. CCS '26.
...
[Storage] [LVMT: An Efficient Authenticated Storage for Blockchain](https://www.usenix.org/conference/osdi23/presentation/li-chenxing). Chenxing Li, Sidi Mohamed Beillahi, Guang Yang, Ming Wu, Wei Xu, Fan Long. OSDI'23.
...
[Consensus-Fairness] [FairDAG: Consensus Fairness over Multi-Proposer Causal Design](). Dakai Kang, Junchao Chen, Tien Tuan Anh Dinh, Mohammad Sadoghi. VLDB '25.
...
[Smart Contract] [Turn the Rudder: A Beacon of Reentrancy Detection for Smart Contracts on Ethereum](https://conf.researchr.org/details/icse-2023/icse-2023-technical-track/50/). ICSE '23.

[Smart Contract] [BSHUNTER: Detecting and Tracing Defects of Bitcoin Scripts](https://conf.researchr.org/details/icse-2023/icse-2023-technical-track/93/). ICSE '23.

[Smart Contract] [DAppHunter: Identifying Inconsistent Behaviors of Blockchain-based Decentralized Applications](https://conf.researchr.org/details/icse-2023/icse-2023-technical-track/). ICSE '23.

[Smart Contract] [Demystifying and Detecting Cryptographic Defects in Ethereum Smart Contracts](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/5/). ICSE '25.

[Smart Contract] [Definition and Detection of Centralization Defects in Smart Contracts](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/129/). ICSE '25.

[Smart Contract] [Enhancing The Open Network: Definition and Automated Detection of Smart Contract Defects](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/92/). ICSE '25.

[Smart Contract] [FairChecker: Detecting Fund-stealing Bugs in DeFi Protocols via Fairness Validation](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/76/). ICSE '25.

[Smart Contract] [Chord: Towards a Unified Detection of Blockchain Transaction Parallelism Bugs](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/191/). ICSE '25.

[Smart Contract] [Fork State-Aware Differential Fuzzing for Blockchain Consensus Implementations](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/145/). ICSE '25.

[Smart Contract] [Combining Fine-Tuning and LLM-based Agents for Intuitive Smart Contract Auditing with Justifications](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/33/). ICSE '25.

[Smart Contract] [Code Cloning in Solidity Smart Contracts: Prevalence, Evolution, and Impact on Development](https://conf.researchr.org/details/icse-2025/icse-2025-research-track/102/). ICSE '25.
...
[Smart Contract] [AdvSCanner: Generating Adversarial Smart Contracts to Exploit Reentrancy Vulnerabilities Using LLM and Static Analysis](). Yin Wu, Xiaofei Xie, Chenyang Peng, Dijun Liu, Hao Wu, Ming Fan, Ting Liu, Haijun Wang. ASE '24.

[Smart Contract] [Skyeye: Detecting Imminent Attacks via Analyzing Adversarial Smart Contracts](). Haijun Wang, Yurui Hu, Hao Wu, Dijun Liu, Chenyang Peng, Yin Wu, Ming Fan, Ting Liu. ASE '24.
...
[Smart Contract] [ContractTinker: LLM-Empowered Vulnerability Repair for Real-World Smart Contracts](). Che Wang, Jiashuo Zhang, Jianbo Gao, Libin Xia, Zhi Guan, Zhong Chen. ASE '24.

[Smart Contract] [Oracle-Guided Vulnerability Diversity and Exploit Synthesis of Smart Contracts Using LLMs](). Mojtaba Eshghie, Cyrille Artho. ASE '24.

[Smart Contract] [Semantic Sleuth: Identifying Ponzi Contracts via Large Language Models](). Cong Wu, Jing Chen, Ziwei Wang, Ruichao Liang, Ruiying Du. ASE '24.

[Smart Contract] [PROMFUZZ: Leveraging LLM-Driven and Bug-Oriented Composite Analysis for Detecting Functional Bugs in Smart Contracts](). Xingshuang Lin, Qinge Xie, Binbin Zhao, Yuan Tian, Saman Zonouz, Na Ruan, Jiliang Li, Raheem Beyah, Shouling Ji. ASE '25.

[Smart Contract] [VeriExploit: Automatic Bug Reproduction in Smart Contracts via LLMs and Formal Methods](). Chenfeng Wei, Shiyu Cai, Yiannis Charalambous, Tong Wu, Sangharatna Godboley, Lucas C. Cordeiro. ASE '25.

[Smart Contract] [ACTaint: Agent-Based Taint Analysis for Access Control Vulnerabilities in Smart Contracts](). Huarui Lin, Zhipeng Gao, Jiachi Chen, Xiang Chen, Xiaohu Yang, Lingfeng Bao. ASE '25.

[Smart Contract] [Have We Solved Access Control Vulnerability Detection in Smart Contracts? A Benchmark Study](). Han Liu, Daoyuan Wu, Yuqiang Sun, Shuai Wang, Yang Liu. ASE '25.

[Smart Contract] [FaultSeeker: LLM-Empowered Framework for Blockchain Transaction Fault Localization](). Kairan Sun, Zhengzi Xu, Kaixuan Li, Lyuye Zhang, Yuqiang Sun, Liwei Tan, Yang Liu. ASE '25.

[Smart Contract] [Soleker: Uncovering Vulnerabilities in Solana Smart Contracts](). Kunsong Zhao, Yunpeng Tian, Zuchao Ma, Xiapu Luo. ASE '25.

[Smart Contract] [SolContractEval: A Benchmark for Evaluating Contract-Level Solidity Code Generation](). Zhifan Ye, Jiachi Chen, Zhenzhe Shao, Lingfeng Bao, Xiaohu Yang, Zhongxin Liu. ASE '25.

[Smart Contract] [PrefGen: A Preference-Driven Methodology for Secure Yet Gas-Efficient Smart Contract Generation](). Zhiyuan Peng, Xin Yin, Zijie Zhou, Chenhao Ying, Chao Ni, Yuan Luo. ASE '25.
...
[Smart Contract] [ItyFuzz: Snapshot-Based Fuzzer for Smart Contract](https://2023.issta.org/details/issta-2023-technical-papers/19/). ISSTA '23.

[Smart Contract] [SmartState: Detecting State-Reverting Vulnerabilities in Smart Contracts via Fine-Grained State-Dependency Analysis](https://2023.issta.org/details/issta-2023-technical-papers/70/). ISSTA '23.

[Smart Contract] [Detecting State Inconsistency Bugs in DApps via On-Chain Transaction Replay and Fuzzing](https://2023.issta.org/details/issta-2023-technical-papers/17/). ISSTA '23.
...
[Smart Contract] [Consolidating Smart Contracts with Behavioral Contracts](https://pldi24.sigplan.org/details/pldi-2024-papers/40/). Guannan Wei, Danning Xie, Wuqi Zhang, Yongwei Yuan, Zhuo Zhang. PLDI '24.
